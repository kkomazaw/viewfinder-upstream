...
return [
    ...
    'improvement.initial.action2' => '<strong>現状を評価：</strong> データの場所、ベンダー依存関係、コンプライアンスのギャップのインベントリを実施',
    'improvement.initial.action3' => '<strong>クイックウィンを特定：</strong> 即時の主権リスク（例：データ居住違反、暗号化されていないデータ）に対処',
    'improvement.initial.action4' => '<strong>リソースを確保：</strong> 主権イニシアチブのための初期予算と人員を確保',
    'improvement.initial.action5' => '<strong>初期ポリシーを定義：</strong> データ処理とベンダー選定のための基本ポリシーを作成',
    'improvement.initial.action6' => '<strong>認識を構築：</strong> デジタル主権についてスタッフを教育するための認識キャンペーンを開始',
    'improvement.initial.priorities' => '即時の優先事項：',
    'improvement.initial.priority1' => 'エグゼクティブスポンサーシップと運営委員会の結成',
    'improvement.initial.priority2' => '重要なデータ分類と居住マッピング',
    'improvement.initial.priority3' => 'ベンダー依存関係の評価',
    'improvement.initial.priority4' => 'コンプライアンス要件のドキュメント化（GDPR、NIS2など）',

    // Improvement Actions - Managed Level
    'improvement.managed.title' => '管理レベルの基礎アクション',
    'improvement.managed.intro' => 'プロジェクトは管理されていますが、プロセスはまだ標準化されていません。反復可能な実践を構築します：',
    'improvement.managed.action1' => '<strong>戦略を開発：</strong> ビジネス目標に沿ったデジタル主権ロードマップを作成',
    'improvement.managed.action2' => '<strong>管理を実装：</strong> 暗号化キー管理（BYOK/HYOK）とデータ居住管理を展開',
    'improvement.managed.action3' => '<strong>ガバナンスを確立：</strong> 明確な責任を持つ主権ガバナンス委員会を結成',
    'improvement.managed.action4' => '<strong>手順を文書化：</strong> 主権重要活動のための標準作業手順を作成',
    'improvement.managed.action5' => '<strong>能力を構築：</strong> 主権技術とフレームワークについて技術チームをトレーニング',
    'improvement.managed.action6' => '<strong>ソリューションを評価：</strong> オープンソースと主権対応プラットフォームを調査',
    'improvement.managed.focus' => '主要な焦点領域：',
    'improvement.managed.focus1' => 'データ主権と暗号化管理',
    'improvement.managed.focus2' => '反復可能な評価プロセス',
    'improvement.managed.focus3' => 'ベンダーリスク管理フレームワーク',
    'improvement.managed.focus4' => 'コンプライアンス追跡とレポーティング',

    // Improvement Actions - Defined Level
    'improvement.defined.title' => '定義レベルの標準化アクション',
    'improvement.defined.intro' => 'プロセスは文書化され標準化されています。組織全体の一貫性と最適化に焦点を当てます：',
    'improvement.defined.action1' => '<strong>プロセスを標準化：</strong> すべてのビジネスユニットで主権実践が一貫していることを確保',
    'improvement.defined.action2' => '<strong>標準を実装：</strong> 移植性のためにオープンスタンダードとコンテナ化を採用',
    'improvement.defined.action3' => '<strong>管理を強化：</strong> 高度な監視、監査権限、セキュリティログの主権を実装',
    'improvement.defined.action4' => '<strong>回復力を構築：</strong> 地政学的シナリオのための災害復旧計画を開発しテスト',
    'improvement.defined.action5' => '<strong>オープンソースを拡大：</strong> オープンソースソフトウェアの使用を増やし、戦略的プロジェクトに貢献',
    'improvement.defined.action6' => '<strong>認証を追求：</strong> 関連する認証を取得（NIS2、SecNumCloud、FedRAMPなど）',
    'improvement.defined.priorities' => '進歩の優先事項：',
    'improvement.defined.priority1' => 'プロセスの標準化とドキュメント化',
    'improvement.defined.priority2' => 'クラウドプラットフォームの移植性テスト',
    'improvement.defined.priority3' => '組織全体のトレーニングプログラム',
    'improvement.defined.priority4' => '主権メトリクスとKPIの定義',

    // Improvement Actions - Quantitative Level
    'improvement.quantitative.title' => '定量的管理レベルの測定アクション',
    'improvement.quantitative.intro' => 'プロセスは測定され統計的に管理されています。データ駆動型の意思決定を通じて最適化します：',
    'improvement.quantitative.action1' => '<strong>メトリクスを確立：</strong> 定量的な主権パフォーマンス指標を定義し追跡',
    'improvement.quantitative.action2' => '<strong>パフォーマンスを分析：</strong> 統計技法を使用してプロセスの変動を理解',
    'improvement.quantitative.action3' => '<strong>目標を設定：</strong> 主権のための定量的な品質とパフォーマンス目標を確立',
    'improvement.quantitative.action4' => '<strong>管理を検証：</strong> 主権管理の有効性を定期的にテストし測定',
    'improvement.quantitative.action5' => '<strong>パフォーマンスをベンチマーク：</strong> メトリクスを業界標準およびピアと比較',
    'improvement.quantitative.action6' => '<strong>リソースを最適化：</strong> データを使用して非効率を特定し排除',
    'improvement.quantitative.focus' => '卓越性の焦点：',
    'improvement.quantitative.focus1' => '高度な分析とメトリクスダッシュボード',
    'improvement.quantitative.focus2' => '統計的プロセス管理技法',
    'improvement.quantitative.focus3' => '継続的な監視とアラート',
    'improvement.quantitative.focus4' => 'パフォーマンスベースラインと目標',

    // Improvement Actions - Optimizing Level
    'improvement.optimizing.title' => '最適化レベルのイノベーションアクション',
    'improvement.optimizing.intro' => '継続的な改善とイノベーションに焦点を当てます。業界のベストプラクティスをリードします：',
    'improvement.optimizing.action1' => '<strong>イノベーションを推進：</strong> 革新的な主権技術と実践を試験的に導入',
    'improvement.optimizing.action2' => '<strong>継続的改善：</strong> 定量的フィードバックを使用してプロセスを継続的に最適化',
    'improvement.optimizing.action3' => '<strong>知識を共有：</strong> ベストプラクティスを業界およびオープンソースコミュニティと文書化し共有',
    'improvement.optimizing.action4' => '<strong>標準をリード：</strong> デジタル主権の標準とフレームワークに貢献し影響を与える',
    'improvement.optimizing.action5' => '<strong>範囲を拡大：</strong> 新興技術（AI、エッジ、量子）に主権原則を適用',
    'improvement.optimizing.action6' => '<strong>先を行く：</strong> 進化する規制と地政学的変化を積極的に監視し適応',
    'improvement.optimizing.note' => '<strong>注記：</strong> 最適化レベルでは、焦点は管理の実装からイノベーションとデジタル主権におけるソートリーダーシップへと移ります。',

    'results.domain_insights' => 'ドメインインサイト',
    'results.domain_insights.intro' => 'すべてのドメインにわたる具体的な回答を確認してください：',
    'results.domain_insights.requirements_identified' => '特定された要件：',
    'results.domain_insights.no_requirements' => 'この評価ではデジタル主権要件は特定されませんでした。他の価値提案に焦点を当てることを検討してください。',
